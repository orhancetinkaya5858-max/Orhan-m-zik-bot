...
async def handle_muzik(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # SoundCloud hata verirse buraya düşecek ve Deezer'a geçecek
        print("SoundCloud başarısız, Deezer deneniyor...")

    # 2. ADIM: DEEZER DENEMESİ (SoundCloud başarısız olduysa veya hata verdiyse)
    if not success:
        try:
            await msg.edit_text("🎵 SoundCloud'da sorun çıktı, Deezer'dan getiriyorum...")
    ...
    if success:
        ...
        await msg.edit_text("Maalesef abi, bu şarkı ne SoundCloud'da ne de Deezer'da bulunamadı.")
